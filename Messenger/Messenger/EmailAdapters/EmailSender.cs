...
namespace Messenger.EmailAdapters
{
    public class EmailSender : IEmailSender
    {
        ...
        public Task Execute(string subject, string message, string email)
        {
            ...
            {
                Text = "If you are registered on the Messenger." + message + Environment.NewLine + Environment.NewLine + "This email is automatically generated. Please do not reply to it."
            };
